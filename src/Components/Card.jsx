      ...
      <div className='w-full min-h-[35rem] mt-[19rem] md:mt-[8rem]'>
        <div className='w-[95%] mx-auto'>
          ...
          <div className='md:flex justify-center items-center'>
            ...
            >
              <SwiperSlide><Card2 title='LUXURY ROOM' image={Pic1} price='$220' /></SwiperSlide>
              <SwiperSlide><Card2 title='LUXURY ROOM' image={Pic2} price='$220' /></SwiperSlide>
              <SwiperSlide><Card2 title='LUXURY ROOM' image={Pic3} price='$220' /></SwiperSlide>
              <SwiperSlide><Card2 title='LUXURY ROOM' image={Pic3} price='$220' /></SwiperSlide>
              <SwiperSlide><Card2 title='LUXURY ROOM' image={Pic4} price='$220' /></SwiperSlide>
              <SwiperSlide><Card2 title='LUXURY ROOM' image={Pic1} price='$220' /></SwiperSlide>
            </Swiper>
          </div>
        </div>
